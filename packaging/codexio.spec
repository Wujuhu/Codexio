...
VERSION = re.search(r'^__version__ = "([0-9]+\.[0-9]+\.[0-9]+)"$',
                    (SRC / "codexio" / "__init__.py").read_text(encoding="utf-8"), re.MULTILINE).group(1)
...
VERSION_INFO = VSVersionInfo(
    ...
    kids=[StringFileInfo([StringTable("040904B0", [
        StringStruct("FileDescription", "Codexio"), StringStruct("InternalName", "Codexio"),
        StringStruct("OriginalFilename", "Codexio.exe"), StringStruct("ProductName", "Codexio"),
