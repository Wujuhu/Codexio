...
- **Main wordmark:** preserve the 32 px app icon and inset it 4 px to the right, reducing the icon/name gap to 4 px so the lettering keeps its left edge. Use Times New Roman at 22 px and weight 600 for Codexio, with 4 px top/side padding and no bottom padding.
