...
from aiquota.rate_limits import QuotaState, QuotaStatus, format_updated_time, should_show_five_hour
...
class QuotaWindow(QWidget):
    ...
    def apply_theme(self, name: str = "dark") -> None:
        if self._theme_applied:
            return
        from aiquota.theme import theme_colors, apply_dark_menu
