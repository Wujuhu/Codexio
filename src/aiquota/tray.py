...
from aiquota.theme import apply_dark_menu
...
class TrayController:
    ...
    def update_state(self, state: QuotaState, show_five: bool = True) -> None:
        ...
        if show_five:
            ...
            self._tray.setToolTip("AIQuota · Codex 额度  5 hours %s  ·  1 week %s" % (five, week))
            return
        self._tray.setToolTip("AIQuota · Codex 额度  1 week %s" % week)
